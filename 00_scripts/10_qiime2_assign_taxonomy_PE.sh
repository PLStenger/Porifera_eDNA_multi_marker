...
WORKING_DIRECTORY=/scratch_vol1/fungi/Porifera_eDNA_multi_marker/05_QIIME2
OUTPUT=/scratch_vol1/fungi/Porifera_eDNA_multi_marker/05_QIIME2/visual

DATABASE=/scratch_vol1/fungi/Porifera_eDNA_multi_marker/98_database_files
...
######  --input-path /Users/pierre-louisstenger/Documents/PostDoc_02_MetaBarcoding_IAC/02_Data/07_Porifera_eDNA_multi_marker/Porifera_eDNA_multi_marker/98_database_files/silva_nr99_v138_wSpecies_train_set.fa \
