...
trimmomatic PE -Xmx60G -threads 8 -phred33 $WORKING_DIRECTORY/BRG1V4_R1.fastq $WORKING_DIRECTORY/BRG1V4_R2.fastq $OUTPUT/BRG1V4_R1.paired.fastq.gz $OUTPUT/BRG1V4_R1.single.fastq.gz $OUTPUT/BRG1V4_R2.paired.fastq.gz $OUTPUT/BRG1V4_R2.single.fastq.gz ILLUMINACLIP:"$ADAPTERFILE":2:30:10 LEADING:30 TRAILING:30 SLIDINGWINDOW:26:30 MINLEN:150
