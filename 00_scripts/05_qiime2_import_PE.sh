...
WORKING_DIRECTORY=/scratch_vol1/fungi/Porifera_eDNA_multi_marker/03_cleaned_data
OUTPUT=/scratch_vol1/fungi/Porifera_eDNA_multi_marker/05_QIIME2
...
MANIFEST=/scratch_vol1/fungi/Porifera_eDNA_multi_marker/98_database_files/manifest
