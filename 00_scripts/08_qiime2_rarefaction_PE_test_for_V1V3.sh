...
# Note: max-depth should be chosen based on ConTable.qzv (or on /scratch_vol1/fungi/Porifera_eDNA_multi_marker/05_QIIME2/export/visual/ConTable/sample-frequency-detail.csv)
